    ...
    public class Menu
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < menuItems.Length; i++)
            {
                ...
                spriteBatch.DrawString(spriteFont, menuItems[i], location + new Vector2(100, 100), hilight, 0.0f, Vector2.Zero, 0.3f, SpriteEffects.None, 0.0f);
                location.Y += spriteFont.LineSpacing + 20;
            }
        }
    }
}